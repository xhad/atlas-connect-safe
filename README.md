...
If you get any errors related to node-gyp (especially with Node 8 on Windows), try [installing its prerequisites](https://github.com/nodejs/node-gyp#installation).
